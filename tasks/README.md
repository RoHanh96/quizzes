...
| [task-005-geography-quiz-spec](./task-005-geography-quiz-spec/) | Geography — auto-generated MCQ (flags, capitals, landmarks), continent scope, endless until wrong; spec + phased plan only (chưa code). |
